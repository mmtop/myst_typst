...
[# endif #]
  ...
  logo: [# if options.logo #]"[-options.logo | replace('\\', '/')-]"[# else #]none[# endif #],
  cover_page_variant: "[# if options.cover_page_variant #][-options.cover_page_variant-][# else #]simple[# endif #]",
  cover_background_image: [# if options.cover_background_image #]"[-options.cover_background_image | replace('\\', '/')-]"[# elif options.cover_image #]"[-options.cover_image | replace('\\', '/')-]"[# else #]none[# endif #],
  ...
  title_page_image: [# if options.title_page_image #]"[-options.title_page_image | replace('\\', '/')-]"[# else #]none[# endif #],
